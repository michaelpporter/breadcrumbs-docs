...
For example, in the following chain of [[../Explicit-Edge-Builders/Date Notes]], you could run the `Jump to First Neighbour in group:nexts` command to jump from the current note to the next day's note
