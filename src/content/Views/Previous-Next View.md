...
When using [[../Explicit-Edge-Builders/Date Notes]], you can optionally show extra rows in the Previous/Next View for larger time periods. Each row shows the `previous`/`next` neighbour for that period from the current note's date.
