...
Breadcrumbs 4.15.0+ requires **Obsidian 1.13.0 or later**. Obsidian 1.13 is now a full stable release, so the [`1.12-compat`](https://github.com/michaelpporter/breadcrumbs/tree/1.12-compat) branch is frozen at 4.14.7 and no longer receives fixes. Still on Obsidian 1.12? Upgrading Obsidian is free and recommended — Breadcrumbs 4.14.7 will keep working, but won't get further updates.
:::
...
| Date | Version | Change |
| ---- | ------- | ------ |
| 2026-08-03 | [4.21.10](/announcements/announcement-2026-08-03-v42110/) | Fixed a CSS conflict that broke Excalidraw drawings |
| 2026-07-05 | [4.21.1](/announcements/announcement-2026-07-05-v4211/) | Markmap codeblocks get a zoom/fit toolbar |
| 2026-06-29 | [4.20.0](/announcements/announcement-2026-06-29-v4200/) | New Edge Audit Report command: find unused, mergeable, orphaned, and dangling edges |
