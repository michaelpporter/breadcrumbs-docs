...
You can add some under Settings > Custom Implied Relations. Here's the relevant section in the docs: <https://github.com/michaelpporter/breadcrumbs#transitive-implied-relations>. The feature is currently only available in the V4 beta, accessible with the BRAT plugin.
