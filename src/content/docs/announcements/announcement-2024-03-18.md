...
I've been working hard on rebuilding **Breadcrumbs** 🍞 from scratch, and I'm happy to say that many long-standing issues are now resolved, and most functionality has been reintroduced. You can read this note for more info on the changes: <https://github.com/michaelpporter/breadcrumbs/blob/master/V4.md>
