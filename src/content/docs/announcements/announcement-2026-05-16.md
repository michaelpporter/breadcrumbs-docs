...
- **Tree View default depth** — Tree View now has a Default Depth setting (default: `5`), so deep graphs no longer render fully expanded on first open. ([#673](https://github.com/michaelpporter/breadcrumbs/issues/673), 4.8.1)
- **Notebook Navigator support** — Breadcrumbs now integrates with the Notebook Navigator plugin. ([#614](https://github.com/michaelpporter/breadcrumbs/issues/614), 4.8.1)
