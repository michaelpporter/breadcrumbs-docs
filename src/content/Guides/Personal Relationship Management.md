...
Next, add some notes for different people, and link them up using these new fields. For example, in the note about yourself, you can add the following (using the [[../Explicit-Edge-Builders/Typed Links|typed-link edge builder]]):
