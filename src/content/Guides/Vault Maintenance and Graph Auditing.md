...
- **`edges.source`**: Tells you which [[../Explicit-Edge-Builders/Explicit Edge Builders|edge builders]] are active. If `date_note` shows a large count you didn't expect, check your [[../Explicit-Edge-Builders/Date Notes]] settings.
...
> [!TIP]
> Run Graph Stats after any significant change to your [[../Implied-Edge-Builders/Implied Edge Builders|implied relations]] settings. Comparing counts before and after is the fastest way to confirm a rule is doing what you intended.
...
Once you've identified notes that rely on implied edges, you may want to make those edges explicit. The [[Freeze Crumbs to File|Freeze implied edges to note]] command does exactly this: it writes all implied edges leaving the current note into the file as [[../Explicit-Edge-Builders/Typed Links|typed-links]].
...
3. Choose whether to write the edges as [[../Explicit-Edge-Builders/Typed Links#Frontmatter Links|frontmatter links]] or [[../Explicit-Edge-Builders/Typed Links#Dataview Links|Dataview inline fields]].
